...
export default function Home() {
    ...
    async function openReport() { if (!token) {
        setAuthOpen(true);
        return;
    } setReportType("seen"); setObservedAt(localDateTime()); setReportLocation({ source: "current", label: "Current device location", latitude: null, longitude: null, accuracy_meters: 0 }); setPlaceResults([]); setPopularLocations([]); setReporting(true); try {
