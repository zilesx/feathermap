...
export default function Home() {
    ...
    useEffect(() => { const hasCoordinates = Number.isFinite(reportLocation.latitude) && Number.isFinite(reportLocation.longitude); if (hasCoordinates && (reportLocation.source === "current" || reportLocation.source === "map") && reportLocationState !== "loading" && reportLocationState !== "selected") setReportLocationState("selected"); }, [reportLocation.source, reportLocation.latitude, reportLocation.longitude, reportLocationState]);
