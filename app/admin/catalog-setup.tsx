...
type Species={slug:string;display_name:string;category_slug:string;enabled:boolean;sort_order:number;scientific_name?:string;typical_flock_min?:number;typical_flock_median?:number;typical_flock_max?:number;occasional_flock_ceiling?:number;large_aggregation?:boolean;habitats?:string[];migration_profile?:{flyways?:string[]}};
