...
const activityLabels={"profile.update":"Updated profile","sighting.create":"Created activity report","sighting.update":"Updated activity report","sighting.delete":"Deleted activity report","sighting.confirm":"Confirmed activity report","comment.create":"Added comment","comment.delete":"Deleted comment","photo.upload":"Uploaded photo","photo.delete":"Deleted photo","session.revoke":"Signed out a device","session.revoke_all":"Signed out everywhere","password.change":"Changed password","mfa.enroll":"Enrolled MFA","mfa.remove":"Removed MFA"};
