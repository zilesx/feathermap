  ...
  try {
    ...
    if (req.method === "POST" && url.pathname === "/api/sightings") {
      ...
      const rows = await supabase("/rest/v1/sightings", { method: "POST", data: {
        reporter_id: user.id,client_report_id:clientReportId, species_slug: input.species, flock_size: input.flock_size, behavior: input.behavior,
